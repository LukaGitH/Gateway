#########################################################################
#  Gateway setup script for all systems
#  Original project: LowPowerLab.com/gateway
...
# make
# sudo make install
# sudo ln -s /usr/local/bin/node /usr/bin/node # don't need this, was for testing
# sudo npm install -g npm@6.14.12
